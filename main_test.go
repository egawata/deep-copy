...
func Test_run(t *testing.T) {
	tests := []struct {
		...
		{name: "issue XXX, parent has child value, value receiver", types: typesVal{"ParentHasChildValue", "Child"}, path: "./testdata", want: []byte(IxxxParentHasChildValueValueRecv)},
		{name: "issue XXX, parent has child pointer, value receiver", types: typesVal{"ParentHasChildPointer", "Child"}, path: "./testdata", want: []byte(IxxxParentHasChildPointerValueRecv)},
		{name: "issue XXX, parent has child value, pointer receiver", pointer: true, types: typesVal{"ParentHasChildValue", "Child"}, path: "./testdata", want: []byte(IxxxParentHasChildValuePointerRecv)},
		{name: "issue XXX, parent has child pointer, pointer receiver", pointer: true, types: typesVal{"ParentHasChildPointer", "Child"}, path: "./testdata", want: []byte(IxxxParentHasChildPointerPointerRecv)},
	}
...
func (o I12StructWithMapOfSlices) DeepCopy() I12StructWithMapOfSlices {
	...
	IxxxParentHasChildValueValueRecv = `// generated by deep-copy; DO NOT EDIT.
...
func (o Child) DeepCopy() Child {
	...
	IxxxParentHasChildPointerValueRecv = `// generated by deep-copy; DO NOT EDIT.
...
func (o Child) DeepCopy() Child {
	...
	IxxxParentHasChildValuePointerRecv = `// generated by deep-copy; DO NOT EDIT.
...
func (o *Child) DeepCopy() *Child {
	...
	IxxxParentHasChildPointerPointerRecv = `// generated by deep-copy; DO NOT EDIT.
